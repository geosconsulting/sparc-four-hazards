...
def collect_landslide_poplation_frequencies_frm_dbfs(direttorio):
...
def prepare_insert_statements_landslide_monthly_values(paese, adms, dct_values_annual_landslide):
                ...
                if single_adm_chiavi == val_adm:
                    ...
                    for linee_con_corrispondenza_amministrativa in dct_values_annual_landslide.iteritems():
                        if linee_con_corrispondenza_amministrativa[0] == adm2_landslide_keys:
                            if len(linee_con_corrispondenza_amministrativa[1].keys()):
