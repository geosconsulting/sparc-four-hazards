...
class Progetto(object):
    ...
    def __init__(self, paese, admin, code, dbname, user, password):
        ...
        self.admin = admin
        self.code = code
        self.proj_dir = "c:/sparc/projects/floods/"
        ...
        if os.path.isfile("C:/sparc/input_data/geocoded/risk_map/" + self.paese + ".tif"):
            self.risk_raster = "C:/sparc/input_data/geocoded/risk_map/" + self.paese + ".tif"
        else:
...
class HazardAssessmentCountryFlood(Progetto):
    ...
    def calcolo_statistiche_zone_inondazione(self):
        ...
        if sum_val_fld > 0 and sum_val_pop > 0:
            ...
            template_dbf = "C:/sparc/input_data/flood/template_pop_stat.dbf"
...
class MonthlyAssessmentCountryFlood(Progetto):
    ...
    monthly_precipitation_dir = "C:/sparc/input_data/precipitation/"
